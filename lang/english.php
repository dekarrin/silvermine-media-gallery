...
/*************************
  ...
  ********************************************
  ...
  $HeadURL: svn://svn.code.sf.net/p/coppermine/code/tags/cpg1.5.22/lang/english.php $
  $Revision: 8530 $
**********************************************/
...
$lang_admin_php['lang'] = 'Default language - CHANGING WILL CAUSE MODS TO BREAK SITE'; // cpg1.5
$lang_admin_php['language_autodetect'] = 'Autodetect language - CHANGING WILL BREAK SITE'; // cpg1.5
$lang_admin_php['charset'] = 'Character encoding'; // cpg1.5
// 'previous_next_tab'] = 'Display previous/next on tabbed pages'; // cpg1.5
$lang_admin_php['theme'] = 'Theme - CHANGING WILL BREAK MODS!'; // cpg1.5
...
$lang_admin_php['upload_create_album_directory'] = 'Place uploaded files in category/album subdirectories';
...
$lang_db_input_php['upl_success_con'] = 'Your file was successfully uploaded and is being processed. It will be added when finished.';
...
$lang_editpics_php['new_collection'] = 'New Collection'; // smg1.0
$lang_editpics_php['edit_collection'] = 'Edit Collection'; // smg1.0
...
$lang_util_php['sub_dirs_finished'] = '<br />Finished moving files into category/album sub directories!<br />';
$lang_util_php['correct_location'] = '%s has been skipped because it is already in the correct location.';
$lang_util_php['video_conversion_finished'] = '<br />Finished scheduling HTML5-format conversions!<br />';
$lang_util_php['correct_format'] = '%s has been skipped because it is already the correct format.';
