...
/*************************
  ...
  ********************************************
  ...
  $HeadURL: svn://svn.code.sf.net/p/coppermine/code/tags/cpg1.5.22/include/functions.inc.php $
  $Revision: 8530 $
**********************************************/
...
// DEKKY MOD END
{
    ...
    $Pid   = array();
    $Title = array();
    // DEKKY mod start - slideshow size fix
    $Height = array();
    $Width = array();
    // DEKKY mod end
    // DEKKY mod start - full screen slideshow
	$ActualHeight = array();
	$ActualWidth = array();
    // DEKKY mod end
...
// DEKKY MOD END
// DEKKY MOD START - full screen slideshow
	$ActualHeight[$i] = $picture['pheight'];
	$ActualWidth[$i] = $picture['pwidth'];
// DEKKY MOD END
...
// DEKKY MOD START - slideshow size fix
	'width' => $Width['0'],
	'height' => $Height['0'],
// DEKKY MOD END - slideshow size fix
// DEKKY MOD START - full screen slideshow
	'actual_width' => $ActualWidth['0'],
	'actual_height' => $ActualHeight['0']
// DEKKY MOD END
    );
