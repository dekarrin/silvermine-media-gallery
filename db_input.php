...
/*************************
  ...
  ********************************************
  ...
  $HeadURL: svn://svn.code.sf.net/p/coppermine/code/tags/cpg1.5.22/db_input.php $
  $Revision: 8530 $
**********************************************/
...
case 'picture':
    ...
    $category = dkrn_ensure_valid_aid($album);
    ...
    list($filepath, $dest_dir) = dkrn_get_upload_paths($category, $album);
	
	$picture_name = dkrn_get_uploaded_name();
