...
##  $HeadURL: svn://svn.code.sf.net/p/coppermine/code/tags/cpg1.5.22/sql/update.sql $
##  $Revision: 8530 $
##  ********************************************
...
# Config approval
ALTER TABLE CPG_comments add approval tinyint(1) NOT NULL default '1';
ALTER TABLE CPG_comments add spam tinyint(1) NOT NULL default '0';
...
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('albanian', 'Albanian','Albanian','al', 'al', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('arabic', 'Arabic','&#1575;&#1604;&#1593;&#1585;&#1576;&#1610;&#1577;','sa','ar', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('armenian', 'Armenian','','','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('azerbaijani', 'Azerbaijani','','az','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('basque', 'Basque','Euskera','basque','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('bosnian', 'Bosnian','Bosanski','ba','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('brazilian_portuguese', 'Portuguese (Brazilian)','Portugu&ecirc;s Brasileiro','br','', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('bulgarian', 'Bulgarian','&#1041;&#1098;&#1083;&#1075;&#1072;&#1088;&#1089;&#1082;&#1080;','bg','', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('byelorussian', 'Byelorussian','','by','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('catalan', 'Catalan','Catal&agrave;','catalonia','', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('chinese_big5', 'Chinese traditional','&#20013;&#25991; - &#32321;&#39636;','tw','cn', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('chinese_gb', 'Chinese simplified','&#20013;&#25991; - &#31616;&#20307;','cn','cn', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('croatian', 'Croatian','Hrvatski','hr','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('czech', 'Czech','&#x010C;esky','cz','cz', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('danish', 'Danish','Dansk','dk','dk', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('dutch', 'Dutch','Nederlands','nl','nl', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('english', 'English (US)', 'English (US)', 'us','en', '1', '1');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('english_gb', 'English (British)','English (British)','gb','en', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('estonian', 'Estonian','Eesti','ee','ee', '1', '1');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('filipino', 'Filipino Tagalog','','ph','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('finnish', 'Finnish','Suomea','fi','', '1', '1');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('french', 'French','Fran&ccedil;ais','fr','fr', '1', '1');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('galician', 'Galician','Galego','galician','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('georgian', 'Georgian','&#4325;&#4304;&#4320;&#4311;&#4323;&#4314;&#4312;','ge','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('german', 'German (informal)', 'Deutsch (Du)', 'de','de', '1', '1');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('german_formal', 'German (formal)','Deutsch (Sie)','de','de', '1', '1');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('greek', 'Greek','&#917;&#955;&#955;&#951;&#957;&#953;&#954;&#940;','gr','gr', '1', '1');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('hebrew', 'Hebrew','&#1506;&#1489;&#1512;&#1497;&#1514;','il','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('hindi', 'Hindi','&#2361;&#2367;&#2344;&#2381;&#2342;&#2368;','in','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('hungarian', 'Hungarian','Magyarul','hu','', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('icelandic', 'Icelandic','','is','', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('indonesian', 'Indonesian','Bahasa Indonesia','id','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('italian', 'Italian','Italiano','it','it', '1', '1');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('japanese', 'Japanese','&#26085;&#26412;&#35486;','jp','jp', '1', '1');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('kazakh', 'Kazakh','','kz','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('korean', 'Korean','&#54620;&#44397;&#50612;','kr','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('kurdish', 'Kurdish','&#1603;&#1608;&#1585;&#1583;&#1740;','kurdish','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('kyrgyz', 'Kyrgyz','','kg','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('laothian', 'Laothian ','','la','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('latvian', 'Latvian','Latvian','lv','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('lithuanian', 'Lithuanian','Letzeburgisch','lu','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('luxembourgish', 'Luxembourgish','Lietuvi&#0353;kai','lu','', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('macedonian', 'Macedonian','&#1052;&#1072;&#1082;&#1077;&#1076;&#1086;&#1085;&#1089;&#1082;&#1080;','mk','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('malay', 'Malay','Bahasa Melayu','my','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('maltese', 'Maltese','','mt','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('mongolian', 'Mongolian','','mn','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('nepali', 'Nepali','','np','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('norwegian', 'Norwegian','Norsk','no','no', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('persian', 'Persian','&#1601;&#1575;&#1585;&#1587;&#1740;','ir','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('polish', 'Polish','Polski','pl','pl', '1', '1');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('portuguese', 'Portuguese (Portugal)','Portugu&ecirc;s','pt','', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('romanian', 'Romanian','Rom&acirc;n&atilde;','ro','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('russian', 'Russian','&#1056;&#1091;&#1089;&#1089;&#1082;&#1080;&#1081;','ru','ru', '1', '1');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('serbian', 'Serbian','Srpski','rs','', '1', '1');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('slovak', 'Slovak','Slovensky','sk','', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('slovenian', 'Slovenian','Slovensko','si','', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('spanish', 'Spanish','Espa&ntilde;ol','es','es', '1', '1');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('spanish_mx', 'Mexican Spanish','Espa&ntilde;ol mexicano','mx','mx', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('swedish', 'Swedish','Svenska','se','', '1', '1');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('thai', 'Thai','&#3652;&#3607;&#3618;','th','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('turkish', 'Turkish','T&uuml;rk&ccedil;e','tr','', '1', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('tigrinya', 'Tigrinya','','er','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('twi', 'Twi','','gh','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('uighur', 'Uighur','Uighur','uighur','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('ukrainian', 'Ukrainian','&#1059;&#1082;&#1088;&#1072;&#1111;&#1085;&#1089;&#1100;&#1082;&#1072;','ua','', '1', '1');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('uzbek', 'Uzbek','','uz','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('vietnamese', 'Vietnamese','Tieng Viet','vn','', '0', '0');
INSERT INTO CPG_languages (lang_id, english_name, native_name, flag, abbr, available, complete) VALUES ('welsh', 'Welsh','Cymraeg','wales','', '0', '0');

UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='arabic';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='brazilian_portuguese';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='bulgarian';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='catalan';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='chinese_gb';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='czech';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='danish';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='dutch';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='english';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='english_gb';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='estonian';
UPDATE CPG_languages SET `complete` = '1' WHERE `lang_id`='estonian';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='finnish';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='french';
UPDATE CPG_languages SET `complete` = '1' WHERE `lang_id`='french';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='german';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='german_formal';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='greek';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='hungarian';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='icelandic';
UPDATE CPG_languages SET `complete` = '0' WHERE `lang_id`='icelandic';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='italian';
UPDATE CPG_languages SET `complete` = '1' WHERE `lang_id`='italian';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='japanese';
UPDATE CPG_languages SET `complete` = '1' WHERE `lang_id`='japanese';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='luxembourgish';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='norwegian';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='polish';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='portuguese';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='russian';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='serbian';
UPDATE CPG_languages SET `complete` = '1' WHERE `lang_id`='serbian';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='slovak';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='slovenian';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='spanish';
UPDATE CPG_languages SET `complete` = '1' WHERE `lang_id`='spanish';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='spanish_mx';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='swedish';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='turkish';
UPDATE CPG_languages SET `available` = '1' WHERE `lang_id`='ukrainian';
UPDATE CPG_languages SET `complete` = '1' WHERE `lang_id`='ukrainian';
...
ALTER TABLE CPG_users ADD user_email_valid enum('1','') NOT NULL default '';

INSERT INTO CPG_usergroups VALUES (3, 'Anonymous', 0, 0, 1, 0, 0, 0, 0, 1, 1, 3);

UPDATE CPG_users SET user_actkey = '' WHERE user_active = '1';
